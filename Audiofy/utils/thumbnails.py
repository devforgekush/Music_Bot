# Custom thumbnail code for @devforgekush by Kushagra
...
async def get_thumb(videoid: str):
    ...
    arial = ImageFont.truetype("@devforgekush/assets/font2.ttf", 30)
    font = ImageFont.truetype("@devforgekush/assets/font.ttf", 30)
    title_font = ImageFont.truetype("@devforgekush/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("@devforgekush/assets/play_icons.png")
